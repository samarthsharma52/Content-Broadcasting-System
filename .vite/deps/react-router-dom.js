...
function createRoutesStub(routes, _context) {
	return function RoutesTestStub({ initialEntries, initialIndex, hydrationData, future }) {
		...
		return /* @__PURE__ */ React.createElement(FrameworkContext.Provider, { value: frameworkContextRef.current }, /* @__PURE__ */ React.createElement(RouterProvider, { router: routerRef.current }));
	};
}
...
* @license MIT
*/
var import_optional_peer_dep___vite_optional_peer_dep_react_dom_react_router = /* @__PURE__ */ __toESM((/* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = {};
	throw new Error(`Could not resolve "react-dom" imported by "react-router". Is it installed?`);
})))(), 1);
function RouterProvider2(props) {
	return /* @__PURE__ */ React.createElement(RouterProvider, {
		flushSync: import_optional_peer_dep___vite_optional_peer_dep_react_dom_react_router.flushSync,
		...props
	});
}
var ssrInfo = null;
